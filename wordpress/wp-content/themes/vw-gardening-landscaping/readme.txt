...
VW Gardening Landscaping is a refreshing, clean, reliable, robust, dynamic and feature-full gardening and landscaping WordPress theme for lawn services, sod cutting services, gardening and landscaping, lawn decorators, farm producers, garden designers, florists, naturopathy, organic medicinal herbs, grocery store, supermarket, organic shop, landscape architects, environmentalist, grow and sell herbs, flowershop,  wind, hydro, gardening, landscaping, earth, non profit, NGO, charity, fundraising, trust, donation, recycle. It is helpful for Groundskeepers, firewood, ecology, lumberjack, Agriculture, wildlife, soulful resorts, nature photographers, Big or Small gardener Business, green products business website, environmental project and plantation.
...
= 0.5.9 =
* Resolved errors.
* Added sanintize callback.

= 0.6 =
* Added slider and expertise button text option in customizer.
...
* Resolved error of On loading screen expertise section, logo & sticky header are showing.
...
* Added icon for blog post time & single post time option in customizer.
* Changed get started tabs names.
* Resolved error of when open search popup and scrollup & sticky header is dispalying.
...
= 0.8 =
* Removed block pattern tab from get started
...
* Changed footer widget search css.
* Added footer widget search bg color in global color.
...
* changed function for get started popup in function.php.
* Updated language folder.
...
* Added animation for blog page.
* Added css for block pattern. 

= 0.9.3 =
* Added search placeholder text option in customizer.
* Updated language folder.
...
= 1.1.3 =
* Added show/ hide option for footer credit link in customizer.
...
= 1.1.5 =
* Removed show/ hide option for footer credit link in customizer.
...
* Added go pro button in expertise and footer section in customizer.
* Updated language folder.
...
* Added option for date, author, comment, time in single post layout.
...
* Added slider image ovrlay color option in customizer.
* Updated language folder.
...
* Added button letter spacing option in customizer.
* Updated language folder.
...
* Added default slider button text in customizer.
* Added default our expertise section button text in customizer.
* Update language folder.

= 1.2.7 =
* Resolved css error of single post sidebar in responsive media.
* Resolved customizer error.
* Added pro in premium settings.
* Change images of block pattern in get started.
...
* Resolved error for slider heading in responsive media.
* Resolved error for block pattern.

= 1.3.8 =
* Resolved blog post bootstarp error.
* Added cart and checkout css.

= 1.3.9 =  
* Resolved error for topbar social icons.
* Added grid post content option in grid layout settings.
* Resolved error for cart page in responsive media.
* Added view cart button css.
* Changed rtl css.
* Update pot file.

= 1.4 =  
* Added search and categories in sidebar of preview.
* Added classes for color option in global color section.

== Resources ==

VW Gardening Landscaping WordPress Theme, Copyright 2019 VWthemes
VW Gardening Landscaping is distributed under the terms of the GNU GPL.
...
* Krub *
* Source : https://fonts.google.com/specimen/Krub?query=Krub

* Stocksnap Images, 
License: CC0 1.0 Universal (CC0 1.0)
Source: https://stocksnap.io/license

Header Image, Copyright Skitter Photo
License: CC0 1.0 Universal (CC0 1.0)
Source: https://stocksnap.io/photo/6E75687DC5

* All the icons taken from genericons licensed under GPL License.
http://genericons.com/

== Theme Documentation ==
Documentation : https://preview.vwthemesdemo.com/docs/free-vw-gardening-landscaping/
