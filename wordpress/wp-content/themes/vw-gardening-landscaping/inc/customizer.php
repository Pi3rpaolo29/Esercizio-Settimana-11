...
function vw_gardening_landscaping_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'vw_gardening_landscaping_slidersettings' , array(
    	...
    	'description' => __('Free theme has 3 slides options, For unlimited slides and more options </br> <a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/themes/landscaping-wordpress-theme/">GO PRO</a>','vw-gardening-landscaping'),
		'panel' => 'vw_gardening_landscaping_homepage_panel',
		'priority' => 3,
	) );
	...
	$wp_customize->add_section( 'vw_gardening_landscaping_expertise_section' , array(
    	...
    	'description' => __('For more options of expertise section </br> <a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/themes/landscaping-wordpress-theme/">GO PRO</a>','vw-gardening-landscaping'),
		'priority' => null,
		'panel' => 'vw_gardening_landscaping_homepage_panel',
		'priority' => 4,
	) );
	...
	$wp_customize->add_control('vw_gardening_landscaping_about_btn',array(
		'description' => "<a class='go-pro' target='_blank' href='". admin_url(VW_GARDENING_LANDSCAPING_GETSTARTED_URL) ." '>More Info</a>",
		'section'=> 'vw_gardening_landscaping_about',
		'type'=> 'hidden'
	));
	...
	$wp_customize->add_section('vw_gardening_landscaping_footer',array(
		...
		'description' => __('For more options of footer section </br> <a class="go-pro-btn" target="blank" href="https://www.vwthemes.com/themes/landscaping-wordpress-theme/">GO PRO</a>','vw-gardening-landscaping'),
		'panel' => 'vw_gardening_landscaping_homepage_panel',
	));
