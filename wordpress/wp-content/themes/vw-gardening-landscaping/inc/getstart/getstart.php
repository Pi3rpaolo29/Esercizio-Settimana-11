...
<div class="wrapper-info">
    ...
    <div class="tab-sec">
		<div class="tab">
			...
			<button class="tablinks" onclick="vw_gardening_landscaping_open_tab(event, 'gutenberg_editor')"><?php esc_html_e( 'Setup With Gutunberg Block', 'vw-gardening-landscaping' ); ?></button>
			<button class="tablinks" onclick="vw_gardening_landscaping_open_tab(event, 'product_addons_editor')"><?php esc_html_e( 'Woocommerce Product Addons', 'vw-gardening-landscaping' ); ?></button>
		...
		<div id="block_pattern" class="tabcontent">
				        ...
				        <?php if ($vw_gardening_landscaping_actions): foreach ($vw_gardening_landscaping_actions as $key => $vw_gardening_landscaping_actionValue): ?>
				                <div class="vw-gardening-landscaping-action" id="<?php echo esc_attr($vw_gardening_landscaping_actionValue['id']);?>">
			                        <div class="action-inner">
			                            ...
			                            <div class="action-desc"><?php echo esc_html($vw_gardening_landscaping_actionValue['desc']); ?></div>
			                            <?php echo wp_kses_post($vw_gardening_landscaping_actionValue['link']); ?>
			                            <a class="ibtana-skip-btn" href="javascript:void(0);" get-start-tab-id="gutenberg-editor-tab"><?php esc_html_e('Skip','vw-gardening-landscaping'); ?></a>
			                        </div>
				                </div>
				            <?php endforeach;
				        endif; ?>
			...
			<?php } ?>
			<div class="gutenberg-editor-tab" style="<?php echo esc_attr($vw_gardening_landscaping_plugin_custom_css); ?>">
				<div class="block-pattern-img">
					...
					<p><?php esc_html_e('Follow the below instructions to setup Home page with Block Patterns.','vw-gardening-landscaping'); ?></p>
	              	<p><b><?php esc_html_e('Click on Below Add new page button >> Click on "+" Icon ','vw-gardening-landscaping'); ?></span></b></p>
	              	<div class="vw-gardening-landscaping-pattern-page">
				    	<a href="javascript:void(0)" class="vw-pattern-page-btn button-primary button"><?php esc_html_e('Add New Page','vw-gardening-landscaping'); ?></a>
				    </div>
	              	<img src="<?php echo esc_url(get_template_directory_uri()); ?>/inc/getstart/images/block-pattern1.png" alt="" />
	              	 <p><b><?php esc_html_e('Click on Patterns Tab >> Click on Theme Name >> Click on Section >> Publish.','vw-gardening-landscaping'); ?></span></b></p>
              	...
              	<div class="block-pattern-link-customizer">
						...
						<div class="first-row">
							<div class="row-box">
								...
								<div class="row-box2">
									<span class="dashicons dashicons-networking"></span><a href="<?php echo esc_url( admin_url('customize.php?autofocus[section]=vw_gardening_landscaping_social_icon_settings') ); ?>" target="_blank"><?php esc_html_e('Social Icons','vw-gardening-landscaping'); ?></a>
								</div>
							</div>
							<div class="row-box">
								<div class="row-box1">
		...
		<div id="gutenberg_editor" class="tabcontent">
			...
			<?php }else{ ?>
				<h3><?php esc_html_e( 'Gutunberg Blocks', 'vw-gardening-landscaping' ); ?></h3>
				<hr class="h3hr">
				<div class="vw-gardening-landscaping-pattern-page">
			    	<a href="<?php echo esc_url( admin_url( 'admin.php?page=ibtana-visual-editor-templates' ) ); ?>" class="vw-pattern-page-btn ibtana-dashboard-page-btn button-primary button"><?php esc_html_e('Ibtana Settings','vw-gardening-landscaping'); ?></a>
			   </div>
		...
		<div id="product_addons_editor" class="tabcontent">
			<?php if(!class_exists('IEPA_Loader')){
				$plugin_ins = VW_Gardening_Landscaping_Plugin_Activation_Woo_Products::get_instance();
				$vw_gardening_landscaping_actions = $plugin_ins->recommended_actions;
				?>
				<div class="vw-gardening-landscaping-recommended-plugins">
					    <div class="vw-gardening-landscaping-action-list">
			...
			<?php }else{ ?>
				<h3><?php esc_html_e( 'Woocommerce Products Blocks', 'vw-gardening-landscaping' ); ?></h3>
				<hr class="h3hr">
				<div class="vw-gardening-landscaping-pattern-page">
					<p><?php esc_html_e('Follow the below instructions to setup Products Templates.','vw-gardening-landscaping'); ?></p>
					<p><b><?php esc_html_e('1. First you need to activate these plugins','vw-gardening-landscaping'); ?></b></p>
						<p><?php esc_html_e('1. Ibtana - WordPress Website Builder ','vw-gardening-landscaping'); ?></p>
						<p><?php esc_html_e('2. Ibtana - Ecommerce Product Addons.','vw-gardening-landscaping'); ?></p>
						<p><?php esc_html_e('3. Woocommerce','vw-gardening-landscaping'); ?></p>

					<p><b><?php esc_html_e('2. Go To Dashboard >> Ibtana Settings >> Woocommerce Templates','vw-gardening-landscaping'); ?></span></b></p>
	              	<div class="vw-gardening-landscaping-pattern-page">
			    		<a href="<?php echo esc_url( admin_url( 'admin.php?page=ibtana-visual-editor-woocommerce-templates&ive_wizard_view=parent' ) ); ?>" class="vw-pattern-page-btn ibtana-dashboard-page-btn button-primary button"><?php esc_html_e('Woocommerce Templates','vw-gardening-landscaping'); ?></a>
			    	</div>
	              	<p><?php esc_html_e('You can create a template as you like.','vw-gardening-landscaping'); ?></span></p>
			    </div>
			<?php } ?>
		</div>
